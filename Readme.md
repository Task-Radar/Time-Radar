...
A time blindness tool. It tracks how long ago you did
recurring tasks and shows you what's drifting using colour codes.

## How it works

- Add tasks with a frequency (e.g. "every 7 days")
- Mark them done when you do them
- The app sorts by urgency so you can see what needs attention
